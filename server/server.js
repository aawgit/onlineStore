...
// server will run from the same dir as client after build
...
app.listen(port, () => {
	console.log(
		`\x1b[91m Server listening on \x1b[36m${process.env.APP_URL}\x1b[91m in \x1b[36m${process.env.NODE_ENV}\x1b[91m mode!\x1b[0m`
	);
});
